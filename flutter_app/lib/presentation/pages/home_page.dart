...
class HomePage extends ConsumerWidget {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Font Test: OpenDyslexic",
                          style: TextStyle(
                            fontFamily: ThemeConfig.fontFamilyPrimary,
                        ...
                        Text(
                          "This text should look weighted at the bottom if the font is working.",
                          style: TextStyle(
                            fontFamily: ThemeConfig.fontFamilyPrimary,
                            fontSize: 14,
                            color: isDark
                  ...
                  _buildSectionTitle(
                      context, l10n.translate('ai_tools'), isDark),
                  const SizedBox(height: 16),
                  _buildToolsGrid(context, isDark, l10n),
                  const SizedBox(height: 32),
                  _buildSectionTitle(
                      context, l10n.translate('recent_history'), isDark),
                  const SizedBox(height: 16),
  ...
  Widget _buildLanguageOption(
      BuildContext context, WidgetRef ref, String name, Locale locale) {
    final isSelected = ref.read(languageProvider).locale == locale;
    return ListTile(
      title: Text(name),
      trailing: isSelected
          ? const Icon(Icons.check, color: ThemeConfig.primaryColor)
          : null,
      onTap: () {
